class SearchController < ApplicationController
  ...
  def organizations_for
    ...
    elsif params[:group_type]
      @organizations = LocalOrganization.allowed_group_type?(params[:group_type]) ? LocalOrganization.where(:group_type => params[:group_type]) : LocalOrganization.scoped
      @organizations = @organizations.orderby_name      
      render :template => 'search/organizations_id_for_search', :layout => nil
    else
